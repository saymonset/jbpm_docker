  ...
  <version>1.0</version>*/
    ...
    public String quickstarts() {
        ...
        //Debe estar en el mismo contexto cuando el taskService viene de runtime.getTaskService()
        {
            ...
            uft.chapter02.CustomMessage processVar2 = new uft.chapter02.CustomMessage();
            processVar2.setMessage("Hola simons");
            ksession.setGlobal("processVar2", processVar2);
            ProcessInstance processInstance =
                    ksession.startProcess("proceso1", params);
